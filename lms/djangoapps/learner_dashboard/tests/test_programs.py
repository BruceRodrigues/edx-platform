...
VIEWS_MODULE = 'lms.djangoapps.learner_dashboard.views'
...
class TestProgramListing(ProgramsApiConfigMixin, CredentialsApiConfigMixin, SharedModuleStoreTestCase):
    ...
    @mock.patch(VIEWS_MODULE + '.get_programs_credentials')
    def test_certificates_listed(self, mock_get_programs_credentials, mock_get_programs):
        """
...
@skip_unless_lms
@mock.patch(VIEWS_MODULE + '.get_programs')
